...
const Signup = ()=>{
    ...
    <Button sx={styles.button} isLoading={isSubmitting} type='submit'>Send email</Button> 
        </VStack>
    </form>
    </Box>
     <Text sx={styles.bottomText}>Remember password? <Link href="/login"><a style={{color:"#0275BB"}}>Log in</a></Link></Text>
    </Box>
}
